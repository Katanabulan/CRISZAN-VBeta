...
function setupLoginForm() {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', function(e) {
            ...
            if (email === 'BetaTester@gmail.com' && password === '123') {
    ...
    link.addEventListener('click', function() {
        ...
        function createStars() {
            ...
            for (let i = 0; i < starCount; i++) {
                ...
                const starType = starSize < 1 ? 'small' : starSize < 2 ? 'medium' : 'large';
        ...
        function createAsteroids() {
            ...
            for (let i = 0; i < asteroidCount; i++) {
                ...
                // Posisi awal acak
                const startY = Math.random() * 80; // 0-80% dari tinggi layar
                ...
                const duration = 25 + Math.random() * 35; // 25-60 detik
                const delay = Math.random() * 15; // 0-15 detik
                
                asteroid.style.animation = `float ${duration}s linear ${delay}s infinite`;
        ...
        function createComets() {
            ...
            for (let i = 0; i < cometCount; i++) {
                ...
                // Posisi awal acak
                const startY = Math.random() * 30; // 0-30% dari tinggi layar
                comet.style.left = '-10px';
                comet.style.top = `${startY}%`;
                
                // Durasi dan delay animasi acak
                const duration = 8 + Math.random() * 12; // 8-20 detik
                const delay = Math.random() * 20; // 0-20 detik
                
                comet.style.animation = `cometMove ${duration}s linear ${delay}s infinite`;
